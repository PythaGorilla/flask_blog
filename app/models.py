...
friends =db.Table('friends',
    ...
    db.Column('friendedMe_id', db.Integer, db.ForeignKey('user.id'))
)
...
class User(db.Model):
    ...
    secondary = friends, 
    primaryjoin = (friends.c.friended_id == id), 
    secondaryjoin = (friends.c.friendedMe_id == id), 
    backref = db.backref('friendedMe', lazy = 'dynamic'), 
    lazy = 'dynamic')
